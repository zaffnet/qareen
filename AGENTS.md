...
After activating the virtual environment with `source .venv/bin/activate`, use `python` to run scripts. Scripts use `python3` for consistency when called from shell scripts.
